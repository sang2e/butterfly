...
Files: scene.gltf [2.73MB] > /Users/parksangyee/Desktop/project1/landing-page/public/models/butterfl/scene-transformed.glb [43.67MB] (-1500%)
...
export function Butterfl(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./models/butterfl/scene-transformed.glb')
  ...
  return (
    <group ref={group} {...props}>
      <group name="Sketchfab_Scene">
        ...
        <mesh name="Line001" geometry={nodes.Line001.geometry} material={materials.Line001} position={[32.391, 0, 1.526]} rotation={[-Math.PI / 2, 0, 0]} />
        ...
        <mesh name="Line004" geometry={nodes.Line004.geometry} material={materials.Line004} position={[-29.017, 0, 7.299]} rotation={[-Math.PI / 2, 0, 0]} />
...
useGLTF.preload('./models/butterfl/scene-transformed.glb')
